...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\julianrl_adm\\Experiment_Orthography\\experiment2_b.py',
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions("Lists/"+expInfo['group']+".xlsx", selection='0:3'),
...
trials_2 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("Lists/"+expInfo['group']+".xlsx", selection='46:49'),
...
trials_3 = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions("Lists/"+expInfo['group']+".xlsx", selection='78:81'),
